	...
	return (
		<div className="w-full mx-auto h-auto relative p-4 lg:p-8">
            ...
            <div className="self-start mt-5">
						...
						<div className="self-start mt-5">
							<h2 className="font-medium text-left text-[#b32ed8]">A cegonha está me trazendo para o mundo e, por isso, meus papais organizaram uma festa linda para a minha chegada e você é o nosso convidado especial. Para comemorar o último mês na barriga da mamãe, vamos nos encontrar?</h2>
						</div>
					</div>
